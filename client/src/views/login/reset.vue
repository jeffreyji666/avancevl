    ...
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on"
      ...
      <el-tooltip v-model="capsTooltip" content="Caps lock is On" placement="right" manual>
        <el-form-item prop="newPassword">
          ...
          <el-input :key="passwordType" ref="newPassword" v-model="loginForm.newPassword" :type="passwordType"
            placeholder="newPassword" name="newPassword" tabindex="2" autocomplete="on" @keyup.native="checkCapslock"
            @blur="capsTooltip = false" @keyup.enter.native="handleLogin" />
          <span class="show-pwd" @click="showPwd">
            <svg-icon :icon-class="passwordType === 'password' ? 'eye' : 'eye-open'" />
          </span>
      ...
      <el-tooltip v-model="capsTooltip" content="Caps lock is On" placement="right" manual>
        <el-form-item prop="newPasswordConfirm">
          ...
          <el-input :key="passwordType" ref="newPasswordConfirm" v-model="loginForm.newPasswordConfirm"
            :type="passwordType" placeholder="newPasswordConfirm" name="newPasswordConfirm" tabindex="2"
      ...
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;"
        @click.native.prevent="handleReset">reset</el-button>
    </el-form>
  ...
  data() {
    ...
    return {
      ...
      loginRules: {
        ...
        newPasswordConfirm: [{ required: true, trigger: 'blur', validator: validateNewConfirmPassword }],
      },
